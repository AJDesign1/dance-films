...
/** The "latest production" hero card at the top of the shop. */
export default function FeaturedShow({ show }: { show: ShopShow }) {
  return (
    <Link href={`/show/${show.slug}`} className={styles.featuredCard} style={{ display: "block" }}>
      <div
        className={styles.featMinH}
        style={{
          position: "relative",
          borderRadius: 16,
          overflow: "hidden",
